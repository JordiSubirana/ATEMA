/*
    ...
    WGL loader generated by glad 0.1.12a0 on Sun Dec 11 01:14:38 2016.
...
PFNWGLGETPROCADDRESSPROC_PRIVATE gladWGLGetProcAddressPtr;

static
int open_gl(void) {
    libGL = LoadLibraryW(L"opengl32.dll");
    if(libGL != NULL) {
        gladWGLGetProcAddressPtr = (PFNWGLGETPROCADDRESSPROC_PRIVATE)GetProcAddress(
                libGL, "wglGetProcAddress");
        return gladWGLGetProcAddressPtr != NULL;
    }
...
PFNGLXGETPROCADDRESSPROC_PRIVATE gladWGLGetProcAddressPtr;
#endif
...
int open_gl(void) {
    ...
    for(index = 0; index < (sizeof(NAMES) / sizeof(NAMES[0])); index++) {
        ...
        if(libGL != NULL) {
            ...
            return 1;
#else
            gladWGLGetProcAddressPtr = (PFNGLXGETPROCADDRESSPROC_PRIVATE)dlsym(libGL,
...
#ifndef __APPLE__
    if(gladWGLGetProcAddressPtr != NULL) {
        result = gladWGLGetProcAddressPtr(namez);
    }
#endif
    if(result == NULL) {
#ifdef _WIN32
